 ...
 */
final class Version20241028103720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT UNSIGNED AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED NOT NULL, title VARCHAR(160) NOT NULL, title_slug VARCHAR(160) NOT NULL, text LONGTEXT NOT NULL, article_date_create DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, article_date_posted DATETIME DEFAULT NULL, published TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_23A0E66A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
